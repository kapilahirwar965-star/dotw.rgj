...
with st.sidebar:
    ...
    dept_header = st.text_input(
        ...
        value="कार्यालय कलेक्टर (जनजातीय कार्य तथा अनुसूचित जाति कल्याण विभाग)"
    )
        ...
        if has_key:
            with st.spinner("🤖 शासकीय प्रारूप तैयार किया जा रहा है, कृपया प्रतीक्षा करें..."):
                try:
                    ...
                    # Build prompt inputs
                    prompt = f"कृपया निम्न स्रोत सामग्री के आधार पर '{workflow_type}' का शासकीय प्रारूप तैयार करें:\n\n"
